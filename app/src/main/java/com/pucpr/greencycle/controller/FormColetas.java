...
public class FormColetas extends AppCompatActivity {
    ...
    String F_Result = "Agendamento não Encontrado", F_Result_Company = "Usuário não Encontrado";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DataModel.getInstance().createRequestDatabase(FormColetas.this);
    ...
    public void CheckingDataRequest(){
        if (adapter.getSelected() != null){
            ...
            cursor = sqLiteDatabaseObj.query("Solicitacao",null, "" + "company_email" + "=?"+  " and "+ "client_email" + "=?" + " and "+ "date" + "=?",new String[]{EmailHolder,adapter.getSelected(),"null"}, null, null, null);
            //cursor = sqLiteDatabaseObj.query("Solicitacao",null, "" + "date" + "=?",new String[]{"null"}, null, null, null);
    ...
    public void updateData(){
        ...
        Request r = DataModel.getInstance().getRequest(index);
        r.getClient_idlogin();
        r.getClient_name();
        r.getClient_email();
        ...
        DataModel.getInstance().updateRequest(r, index);
            Toast.makeText(this, "Agendamento cadastrado com sucesso. Com "+adapter.getSelected(), Toast.LENGTH_SHORT).show();
            finish();
        }else{
